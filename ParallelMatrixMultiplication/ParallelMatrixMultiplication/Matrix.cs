...
public static class Matrix
{
    ...
    /// <summary>
    /// Check the equality of the matrices.
    /// </summary>
    /// <param name="matrix1">The first matrix is for comparison.</param>
    /// <param name="matrix2">The second matrix is for comparison.</param>
